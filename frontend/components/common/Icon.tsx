...
type IconName = 'linkedin' | 'github' | 'email' | 'phone' | 'location' | 'add' | 'delete' | 'palette' | 'font' | 'fontSize' | 'upload' | 'check' | 'lightbulb' | 'pencil' | 'briefcase' | 'graduationCap' | 'download' | 'logout';
...
const ICONS: Record<IconName, React.JSX.Element> = {
  ...
  graduationCap: <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0l-.07.003-.02.002-.006.002-.002.001-.001.001A49.953 49.953 0 0112 15.493a49.953 49.953 0 018.232-5.346l-.002-.001-.006-.002-.02-.002-.07-.003" />,
